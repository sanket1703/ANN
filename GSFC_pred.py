...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 16 14:51:42 2020
...
df = web.DataReader('GSFC.BO' , data_source = 'yahoo' , start = '2012-01-01',end = '2020-03-14')
...
#This part is to make predictions based on the previous 60 days
df1 = web.DataReader('GSFC.BO' , data_source = 'yahoo' , start = '2012-01-01',end = '2019-09-1')
...
p = scaler.inverse_transform(predict1)
p1 = p.tolist()

#p1 is the final prediction 
print(p1)
